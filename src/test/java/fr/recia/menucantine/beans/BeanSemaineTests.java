...
public class BeanSemaineTests {
    ...
    public void setup(){
        ...
        SousMenu entree = new SousMenu(new ArrayList<>(Collections.singletonList(plat1)), 0);
        Plat plat2 = new Plat("plat2","plat");
        Plat plat21 = new Plat("plat21","plat");
        SousMenu plat = new SousMenu(new ArrayList<>(Arrays.asList(plat2, plat21)), 1);
        Plat plat3 = new Plat("plat3", "accompagnement");
        SousMenu accompagnement = new SousMenu(new ArrayList<>(Collections.singletonList(plat3)), 2);
        Plat plat4 = new Plat("plat4", "fromage");
        Plat plat41 = new Plat("plat41", "fromage");
        Plat plat42 = new Plat("plat42", "fromage");
        SousMenu fromage = new SousMenu(new ArrayList<>(Arrays.asList(plat4, plat41, plat42)), 3);
        Plat plat5 = new Plat("plat5", "dessert");
        SousMenu dessert = new SousMenu(new ArrayList<>(Collections.singletonList(plat5)), 4);
        Plat plat6 = new Plat("plat6", "autre");
        SousMenu autre = new SousMenu(new ArrayList<>(Collections.singletonList(plat6)), 5);
        ...
        SousMenu entrees2 = new SousMenu(new ArrayList<>(Collections.singletonList(plat1s2)), 0);
        Plat plat2s2 = new Plat("plat2s2","plat");
        Plat plat21s2 = new Plat("plat21s2","plat");
        SousMenu plats2 = new SousMenu(new ArrayList<>(Arrays.asList(plat2s2, plat21s2)), 1);
        Plat plat3s2 = new Plat("plat3s2", "accompagnement");
        SousMenu accompagnements2 = new SousMenu(new ArrayList<>(Collections.singletonList(plat3s2)), 2);
        Plat plat4s2 = new Plat("plat4s2", "fromage");
        Plat plat41s2 = new Plat("plat41s2", "fromage");
        SousMenu fromages2 = new SousMenu(new ArrayList<>(Arrays.asList(plat4s2, plat41s2)), 3);
        Plat plat5s2 = new Plat("plat5s2", "dessert");
        Plat plat51s2 = new Plat("plat51s2", "dessert");
        SousMenu desserts2 = new SousMenu(new ArrayList<>(Arrays.asList(plat5s2, plat51s2)), 4);
        Plat plat6s2 = new Plat("plat6s2", "autre");
        SousMenu autres2 = new SousMenu(new ArrayList<>(Collections.singletonList(plat6s2)), 5);
        ...
        SousMenu j2entree = new SousMenu(new ArrayList<>(Collections.singletonList(j2plat1)), 0);
        Plat j2plat2 = new Plat("j2plat2","plat");
        SousMenu j2plat = new SousMenu(new ArrayList<>(Collections.singletonList(j2plat2)), 1);
        Plat j2plat3 = new Plat("j2plat3", "accompagnement");
        SousMenu j2accompagnement = new SousMenu(new ArrayList<>(Collections.singletonList(j2plat3)), 2);
        Plat j2plat4 = new Plat("j2plat4", "fromage");
        Plat j2plat41 = new Plat("j2plat41", "fromage");
        SousMenu j2fromage = new SousMenu(new ArrayList<>(Arrays.asList(j2plat4, j2plat41)), 3);
        Plat j2plat5 = new Plat("j2plat5", "dessert");
        Plat j2plat51 = new Plat("j2plat51", "dessert");
        SousMenu j2dessert = new SousMenu(new ArrayList<>(Arrays.asList(j2plat5, j2plat51)), 4);
        Plat j2plat6 = new Plat("j2plat6", "autre");
        SousMenu j2autre = new SousMenu(new ArrayList<>(Collections.singletonList(j2plat6)), 5);
        ...
        SousMenu j2entrees2 = new SousMenu(new ArrayList<>(Collections.singletonList(j2plat1s2)), 0);
        Plat j2plat2s2 = new Plat("j2plat2s2","plat");
        Plat j2plat21s2 = new Plat("j2plat21s2","plat");
        Plat j2plat22s2 = new Plat("j2plat22s2","plat");
        SousMenu j2plats2 = new SousMenu(new ArrayList<>(Arrays.asList(j2plat2s2, j2plat21s2, j2plat22s2)), 1);
        Plat j2plat3s2 = new Plat("j2plat3s2", "accompagnement");
        Plat j2plat31s2 = new Plat("j2plat3s2", "accompagnement");
        SousMenu j2accompagnements2 = new SousMenu(new ArrayList<>(Arrays.asList(j2plat3s2, j2plat31s2)), 2);
        Plat j2plat4s2 = new Plat("j2plat4s2", "fromage");
        SousMenu j2fromages2 = new SousMenu(new ArrayList<>(Collections.singletonList(j2plat4s2)), 3);
        Plat j2plat5s2 = new Plat("j2plat5s2", "dessert");
        Plat j2plat51s2 = new Plat("j2plat51s2", "dessert");
        SousMenu j2desserts2 = new SousMenu(new ArrayList<>(Arrays.asList(j2plat5s2, j2plat51s2)), 4);
        Plat j2plat6s2 = new Plat("j2plat6s2", "autre");
        SousMenu j2autres2 = new SousMenu(new ArrayList<>(Collections.singletonList(j2plat6s2)), 5);
    ...
    public void testCleanAndCompleteSemaine(){
        ...
        semaine.clean();
        semaine.complete();
        assertEquals("La semaine doit contenir 2 jours", 2, semaine.getJours().size(), 2);
        assertEquals("Chaque jour doit contenir 2 services", 2, semaine.getJours().get(0).getDestinations().size(), 2);
        assertEquals("Chaque jour doit contenir 2 services", 2, semaine.getJours().get(1).getDestinations().size(), 2);
        assertEquals("Les sous-menus doivent être complétés correctement : première journée, premier service, cinquième sous-menu",
                2, semaine.getJours().get(0).getDestinations().get(0).getMenu().get(4).getChoix().size());
        assertEquals("Les sous-menus doivent être complétés correctement : première journée, deuxième service, deuxième sous-menu",
                3, semaine.getJours().get(0).getDestinations().get(1).getMenu().get(1).getChoix().size());
        assertEquals("Les sous-menus doivent être complétés correctement : première journée, deuxième service, troisième sous-menu",
                2, semaine.getJours().get(0).getDestinations().get(1).getMenu().get(2).getChoix().size());
        assertEquals("Les sous-menus doivent être complétés correctement : deuxième journée, premier service, deuxième sous-menu",
                2, semaine.getJours().get(1).getDestinations().get(0).getMenu().get(1).getChoix().size());
        assertEquals("Les sous-menus doivent être complétés correctement : deuxième journée, premier service, quatrième sous-menu",
                3, semaine.getJours().get(1).getDestinations().get(0).getMenu().get(3).getChoix().size());
        assertEquals("Les sous-menus doivent être complétés correctement : deuxième journée, deuxième service, quatrième sous-menu",
                2, semaine.getJours().get(1).getDestinations().get(1).getMenu().get(3).getChoix().size());
        assertEquals("Le nombre de plat max par service doit être correct",
                1, semaine.getNbPlatMaxParService().get("Déjeuner").get(0), 0);
        assertEquals("Le nombre de plat max par service doit être correct",
                2, semaine.getNbPlatMaxParService().get("Déjeuner").get(1), 0);
        assertEquals("Le nombre de plat max par service doit être correct",
                3, semaine.getNbPlatMaxParService().get("Déjeuner").get(3), 0);
        assertEquals("Le nombre de plat max par service doit être correct",
                2, semaine.getNbPlatMaxParService().get("Diner").get(2), 0);
        assertEquals("Le nombre de plat max par service doit être correct",
                2, semaine.getNbPlatMaxParService().get("Diner").get(4), 0);
        assertEquals("Le nombre de plat max par service doit être correct",
                1, semaine.getNbPlatMaxParService().get("Diner").get(5), 0);
    }
